	...
	return {
		add: function(l) {
			...
			for (var i = total; i < l + total; i++) {
				...
				var htmlThumb = '<li draggable="true" class="img-box" id="image-place-holder-' + index + '" ' + title + ' id="img-' + index + '">' + '<div class="icon-remove-gray"></div>' + '<img class="thumb" id="thumb-img-' + index + '"  width="64px" height="64px" src="" />' + '<ul id="upload-status-' + index + '" class="upload-status">' + '<li>' + '<div id="progress-cnt-' + index + '" class="progress-holder">' + '<div id="progress-' + index + '" class="progress"></div>' + '</div>' + '<span id="percents-' + index + '" class="percents"></span>' + '</li>' + '<li>' + '<div class="uploading" id="file-upload-' + index + '"></div>' + '</li>' + '</ul>' + '</li>';
		...
		addFromImageUrls: function(urlThumbArray, urlArray) {
			...
			for (var i = 0; i < urlArray.length; i++) {
				...
				var htmlThumb = '<li draggable="true" class="img-box" id="image-place-holder-' + index + '" ' + title + ' id="img-' + index + '">' + '<div class="icon-remove-gray"></div>' + '<img class="thumb" id="thumb-img-' + index + '"  width="64px" height="64px" src="' + urlArray[i] + '" />' + '<ul id="upload-status-' + index + '" class="upload-status">' + '<li>' + '<div id="progress-cnt-' + index + '" class="progress-holder">' + '<div id="progress-' + index + '" class="progress"></div>' + '</div>' + '<span id="percents-' + index + '" class="percents"></span>' + '</li>' + '<li>' + '<div class="uploading" id="file-upload-' + index + '"></div>' + '</li>' + '</ul>' + '</li>';
...
function uploadNoneHtml5(fileEle) {
	...
	var epsForm = {
		action: EPS.url, id: "epsForm" + count, fieldNames: [
			{
				name: "s", value: !EPS.IsEbayDirectUL ? "1C5000" : "Standard"
			}, {
				name: "v", value: "2"
			}, {
				name: "b", value: "18"
