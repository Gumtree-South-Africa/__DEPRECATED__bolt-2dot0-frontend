...
exports.init = function(hbs) {
   ...
   // i18n = i18ns; console.log("i18n xxxxxxxxxxxxxxxxxxxxxxxxxx"  + util.inspect(i18n, {showHidden: false, depth: 1}));
    ...
    exphbs.handlebars.registerHelper('dp', function(partialName, options) {
        return partialName + "/views/hbs/" + partialName + "_" + this.locale;
    });
    ...
    exphbs.handlebars.registerHelper("debug", function(optionalValue) {
        ...
        return util.inspect(this.locale, {showHidden: false, depth: null});
    });

    // register hbs helpers in res.locals' context which provides this.locale
   /* exphbs.handlebars.registerHelper('i18n', function () {
