...
module.exports = {
	"bundleName": "RegisterPage",
	"outputEntry": "app/appWeb/views/templates/pages/registerPage/js/registerPage",
	"common": {
		"core": { // common->core is the base of the pages bundle and has the lowest priority
			...
			"PageMain": "app/appWeb/views/templates/pages/registerPage/js/registerPage.js"
		},
		"mobile": {},
