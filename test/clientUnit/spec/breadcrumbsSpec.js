...
describe('Breadcrumbs', () => {
	it('should find breadcrumbs', () => {
		let $testArea = specHelper.setupTest("breadcrumbsV2_es_MX", { }, "es_MX");

		expect($('.breadcrumbs').length).toBe(1);
	});

	it('should have the proper number of elements', () => {
		let $testArea = specHelper.setupTest("breadcrumbsV2_es_MX", model.locationsAndAd, "es_MX");
	...
	it('should render all item properties', () => {
		let $testArea = specHelper.setupTest("breadcrumbsV2_es_MX", model.locationsOnly, "es_MX");
