...
BAPICall.prototype = {
	 ...
	 */
	doGet: function() {
		var scope = this, data = {}, reqGet = null, err = null;
	...
	preparePost: function(paramsObject) {
		var headers = {}, scope = this, parObj = paramsObject || {}, defaultOptions = {
			port: 80, method: 'POST', headers: headers
		};
	...
	doPost: function(serializedData) {
		var data = {}, scope = this, reqPost = null, err = null;
